...
function Confirmer() {
  ...
  return <div className={styles.big} style={{border:"solid",width:"80%",marginLeft:"10%",alignSelf: "center",marginTop:"3.5%",marginBottom:"3.5%",borderRadius:"3vh",border:"1px solid #707070"}}>
